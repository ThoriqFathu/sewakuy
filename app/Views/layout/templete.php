<!DOCTYPE html>
<html lang="en">
<?php $url = 'http://localhost/CI/public/' ?>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-scrolled">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="active " href="/CI/public">Beranda</a></li>
          <li><a href='/CI/public/lapangan/'>Lapangan</a></li>
          <li><a href="/CI/public/transaksi/">Transaksi</a></li>
