            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="text" id="nama_menu" name="nama_menu" class="form-control <?= isset($errors['nama_menu']) ? 'is-invalid' : '' ?>" value="<?= old('nama_menu') ?>" />
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="text" id="nama_controller" name="nama_controller" class="form-control <?= isset($errors['nama_controller']) ? 'is-invalid' : '' ?>" value="<?= old('nama_controller') ?>" />
                        <div class="invalid-feedback">
